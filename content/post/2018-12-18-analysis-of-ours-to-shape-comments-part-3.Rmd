...
```{r save}
rm(comments_col, comments_dfm_trim, comments_fcm, comments_fcm_cville, comments_simil, comments_comptokens, comments_dfm_comptokens, comments_tokens, dups, kwic_cville, kwic_cville_dfm, comment_top, comment_top_cville, dups_remove, size)
save.image("../../static/data/ots_blog3.RData")
```
